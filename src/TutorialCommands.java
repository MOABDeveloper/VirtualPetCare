...
public class TutorialCommands {
    public String GiftGivingText = "Who doesn't love presents? You can give your pet a gift by clicking the Gift button-or the G key-to dress it up! This will make your pet's happiness meter increase. If your pet gets angry, it will ignore you until you give it a gift!";
    ...
    public String PlayScreenText = "Naturally pets need to play. You can play with your pet by clicking the Play button-or the P key-to let them have fun! Playing makes your happiness meter increase!";
